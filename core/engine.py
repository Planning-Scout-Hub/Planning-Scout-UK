...
COUNCILS = {
    ...
    # ══ East of England ═════════════════════════════════════════
    "North Norfolk":     "https://www.north-norfolk.gov.uk/online-applications",
...
def new_session():
    s = requests.Session()
    # We define a "Human-like" header directly here to override the generic ones
    s.headers.update({
    ...
    s.verify = False # Keep this as per your original code
    return s
